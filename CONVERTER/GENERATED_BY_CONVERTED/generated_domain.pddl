(define (domain from_prolog-domain)
 ...
 (:types cuoco piano strumento cibo luce)
 (:predicates (soddisfatto ?p0 - cuoco) (su ?p0_0 - piano ?p1 - strumento) (ha_fame ?p0 - cuoco) (cotto ?p0_1 - cibo) (disponibile ?p0_2 - strumento) (pieno ?p0_0 - piano) (crudo ?p0_1 - cibo) (vuoto ?p0_0 - piano))
 (:action cucina
