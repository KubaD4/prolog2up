...
moving_onblock_to_block = Fluent('moving_onblock_to_block', BoolType(), p0=Agent)
moving_table_to_table = Fluent('moving_table_to_table', BoolType(), p0=Agent)
on = Fluent('on', BoolType(), p0=Block, p1=Block)
clear = Fluent('clear', BoolType(), p0=Block)
moving_onblock_to_table = Fluent('moving_onblock_to_table', BoolType(), p0=Agent)
...
a1 = Object('a1', Agent)
a2 = Object('a2', Agent)
loc_10_10 = Object('loc_10_10', Pos)
loc_1_1 = Object('loc_1_1', Pos)
loc_2_2 = Object('loc_2_2', Pos)
loc_3_3 = Object('loc_3_3', Pos)
loc_3_3 = Object('loc_3_3', Pos)
loc_1_1 = Object('loc_1_1', Pos)
loc_2_2 = Object('loc_2_2', Pos)
loc_10_10 = Object('loc_10_10', Pos)
...
problem.set_initial_value(at(b3, loc_3_3, loc_3_3), True)
problem.set_initial_value(at(b4, loc_1_1, loc_1_1), True)
problem.set_initial_value(at(b5, loc_2_2, loc_2_2), True)
problem.set_initial_value(at(b6, loc_3_3, loc_3_3), True)
...
problem.add_goal(at(b1, loc_1_1, loc_1_1))
problem.add_goal(at(b2, loc_2_2, loc_2_2))
problem.add_goal(at(b3, loc_3_3, loc_3_3))
problem.add_goal(at(b4, loc_10_10, loc_10_10))
problem.add_goal(at(b5, loc_10_10, loc_10_10))
problem.add_goal(at(b6, loc_3_3, loc_3_3))
...
move_onblock_to_table_start.add_precondition(on(Param2, b1))
move_onblock_to_table_start.add_precondition(at(Param2, Param3, Param4))
move_onblock_to_table_start.add_precondition(at(b1, Param3, Param4))
...
move_onblock_to_table_start.add_effect(on(Param2, b1), False)
...
move_onblock_to_table_start.add_effect(clear(b1), True)
...
move_onblock_to_block_start.add_precondition(on(Param2, b1))
...
move_onblock_to_block_start.add_effect(on(Param2, b1), False)
...
move_onblock_to_block_start.add_effect(clear(b1), True)
