(define (domain from_prolog-domain)
 ...
 (:types block agent vegetale mela pos)
 (:predicates (ontable ?p0 - block) (clear ?p0 - block) (available ?p0_0 - agent) (cruda ?p0_1 - vegetale) (cotta ?p0_1 - vegetale) (morsa ?p0_2 - mela) (moving_table_to_block ?p0_0 - agent ?p1 - block ?p2 - block ?p3 - pos ?p4 - pos ?p5 - pos ?p6 - pos) (at_ ?p0 - block ?p1_0 - pos ?p2_0 - pos) (intera ?p0_2 - mela) (on ?p0 - block ?p1 - block))
 (:action move_table_to_block_start
  ...
  :precondition (and (available ?param1) (ontable ?param2) (at_ ?param2 ?param4 ?param5) (at_ ?param3 ?param6 ?param7) (clear ?param3) (clear ?param2) (not (exists (?any_move_table_to_block_start_0 - block)
 (on ?any_move_table_to_block_start_0 ?param2))) (not (exists (?any_move_table_to_block_start_1 - block)
 (on ?param2 ?any_move_table_to_block_start_1))) (not (exists (?any_move_table_to_block_start_6 - pos ?any_move_table_to_block_start_4 - pos ?any_move_table_to_block_start_0_0 - agent ?any_move_table_to_block_start_5 - pos ?any_move_table_to_block_start_2 - block ?any_move_table_to_block_start_3 - pos)
