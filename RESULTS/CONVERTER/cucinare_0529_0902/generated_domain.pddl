(define (domain from_prolog-domain)
 ...
 (:predicates (pieno ?p0 - piano) (su ?p0 - piano ?p1 - strumento) (cotto ?p0_0 - cibo) (vuoto ?p0 - piano) (soddisfatto ?p0_1 - cuoco) (ha_fame ?p0_1 - cuoco) (crudo ?p0_0 - cibo) (disponibile ?p0_2 - strumento))
 (:action cucina
