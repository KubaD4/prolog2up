...
m1 = Object('m1', Mela)
a1 = Object('a1', Agent)
pos_1 = Object('pos_1', Pos)
pos_2 = Object('pos_2', Pos)
problem.add_objects([
    b1,
    b2,
    carota1,
...
problem.set_initial_value(at(b1, pos_1, pos_1), True)
problem.set_initial_value(at(b2, pos_2, pos_2), True)
...
problem.add_goal(at(b1, pos_2, pos_2))
problem.add_goal(at(b2, pos_2, pos_2))
