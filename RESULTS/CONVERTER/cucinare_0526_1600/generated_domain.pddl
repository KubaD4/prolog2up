(define (domain from_prolog-domain)
 ...
 (:predicates (su ?p0 - piano ?p1 - strumento) (crudo ?p0_0 - cibo) (pieno ?p0 - piano) (soddisfatto ?p0_1 - cuoco) (disponibile ?p0_2 - strumento) (cotto ?p0_0 - cibo) (ha_fame ?p0_1 - cuoco) (vuoto ?p0 - piano))
 (:action cucina
