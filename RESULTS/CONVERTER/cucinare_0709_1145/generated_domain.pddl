(define (domain from_prolog-domain)
 ...
 (:predicates (su ?p0 - piano ?p1 - strumento) (soddisfatto ?p0 - cuoco) (vuoto ?p0 - piano) (cotto ?p0 - cibo) (crudo ?p0 - cibo) (pieno ?p0 - piano) (ha_fame ?p0 - cuoco) (disponibile ?p0 - strumento))
 (:action cucina
