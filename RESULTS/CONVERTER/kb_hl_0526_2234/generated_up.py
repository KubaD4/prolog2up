...
pos_3 = Object('pos_3', Pos)
pos_10 = Object('pos_10', Pos)
...
problem.set_initial_value(at(b3, pos_3, pos_3), True)
problem.set_initial_value(at(b4, pos_1, pos_1), True)
problem.set_initial_value(at(b5, pos_2, pos_2), True)
problem.set_initial_value(at(b6, pos_3, pos_3), True)
...
problem.add_goal(at(b1, pos_1, pos_1))
problem.add_goal(at(b2, pos_2, pos_2))
problem.add_goal(at(b3, pos_3, pos_3))
problem.add_goal(at(b4, pos_10, pos_10))
problem.add_goal(at(b5, pos_10, pos_10))
problem.add_goal(at(b6, pos_3, pos_3))
...
move_onblock_to_table_start = InstantaneousAction('move_onblock_to_table_start', Param1=Agent, Param2=Block, Param3=Pos, Param4=Pos, Param5=Pos, Param6=Pos, Param7=Block)
...
move_onblock_to_table_start.add_precondition(on(Param2, Param7))
move_onblock_to_table_start.add_precondition(at(Param2, Param3, Param4))
move_onblock_to_table_start.add_precondition(at(Param7, Param3, Param4))
...
move_onblock_to_table_start.add_effect(on(Param2, Param7), False)
...
move_onblock_to_table_start.add_effect(clear(Param7), True)
