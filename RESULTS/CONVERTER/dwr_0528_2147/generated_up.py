...
Resource1 = UserType('resource1')
Resource2 = UserType('resource2')
Resource3 = UserType('resource3')
Resource4 = UserType('resource4')
Resource5 = UserType('resource5')
Resources = UserType('resources')
Robot = UserType('robot', Resource1)
# Robot is a subtype of Resource1
Location = UserType('location', Resource4)
# Location is a subtype of Resource4
Crane = UserType('crane', Resource1)
# Crane is a subtype of Resource1
Container = UserType('container', Resource1)
# Container is a subtype of Resource1

Pos = UserType('pos')

# Type Hierarchies Created:
# Resource1 -> ['crane', 'robot', 'container']
# Resource2 -> ['robot', 'container']
# Resource3 -> ['crane', 'robot']
# Resource4 -> ['location', 'container']
# Resource5 -> ['location', 'container']

moving_top_to_ground = Fluent('moving_top_to_ground', BoolType(), p0=Crane, p1=Container, p2=Resource4, p3=Location)
# moving_top_to_ground uses hierarchical types: Resource4(['location', 'container'])
...
available = Fluent('available', BoolType(), p0=Resource3)
# available uses hierarchical types: Resource3(['crane', 'robot'])
...
on = Fluent('on', BoolType(), p0=Container, p1=Resource2)
# on uses hierarchical types: Resource2(['robot', 'container'])
at = Fluent('at', BoolType(), p0=Resource1, p1=Location)
# at uses hierarchical types: Resource1(['crane', 'robot', 'container'])
moving_top_to_top = Fluent('moving_top_to_top', BoolType(), p0=Crane, p1=Container, p2=Resource5, p3=Container, p4=Location)
# moving_top_to_top uses hierarchical types: Resource5(['location', 'container'])
...
move_ground_to_top_end = InstantaneousAction('move_ground_to_top_end', Param1=Crane, Param2=Container, Param3=Container, Param4=Location)
...
load_container_end = InstantaneousAction('load_container_end', Param1=Crane, Param2=Robot, Param3=Container, Param4=Location)
...
unload_container_end = InstantaneousAction('unload_container_end', Param1=Crane, Param2=Robot, Param3=Container, Param4=Location)
...
move_ground_to_ground_end = InstantaneousAction('move_ground_to_ground_end', Param1=Crane, Param2=Container, Param3=Location, Param4=Location)
...
any_move_top_to_ground_start_2 = Variable('any_move_top_to_ground_start_2', Resource4)
...
move_top_to_ground_end = InstantaneousAction('move_top_to_ground_end', Param1=Crane, Param2=Container, Param3=Location, Param4=Location)
...
any_move_top_to_top_start_2 = Variable('any_move_top_to_top_start_2', Resource5)
...
move_top_to_top_end = InstantaneousAction('move_top_to_top_end', Param1=Crane, Param2=Container, Param3=Location, Param4=Container, Param5=Location)
...
move_robot_end = InstantaneousAction('move_robot_end', Param1=Robot, Param2=Location, Param3=Location)
