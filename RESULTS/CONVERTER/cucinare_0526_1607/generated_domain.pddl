(define (domain from_prolog-domain)
 ...
 (:types strumento cuoco piano cibo luce)
 (:predicates (disponibile ?p0 - strumento) (ha_fame ?p0_0 - cuoco) (pieno ?p0_1 - piano) (su ?p0_1 - piano ?p1 - strumento) (cotto ?p0_2 - cibo) (crudo ?p0_2 - cibo) (soddisfatto ?p0_0 - cuoco) (vuoto ?p0_1 - piano))
 (:action cucina
