(define (domain from_prolog-domain)
 ...
 (:types block pos mela agent vegetale)
 (:predicates (at ?p0 - block ?p1 - pos ?p2 - pos) (intera ?p0 - mela) (moving_table_to_block ?p0 - agent ?p1 - block ?p2 - block ?p3 - pos ?p4 - pos ?p5 - pos ?p6 - pos) (ontable ?p0 - block) (on ?p0 - block ?p1 - block) (available ?p0 - agent) (cotta ?p0 - vegetale) (clear ?p0 - block) (cruda ?p0 - vegetale) (morsa ?p0 - mela))
