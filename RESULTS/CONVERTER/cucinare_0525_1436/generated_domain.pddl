(define (domain from_prolog-domain)
 ...
 (:types cuoco strumento piano cibo luce)
 (:predicates (soddisfatto ?p0 - cuoco) (disponibile ?p0_0 - strumento) (ha_fame ?p0 - cuoco) (pieno ?p0_1 - piano) (vuoto ?p0_1 - piano) (su ?p0_1 - piano ?p1 - strumento) (cotto ?p0_2 - cibo) (crudo ?p0_2 - cibo))
 (:action cucina
