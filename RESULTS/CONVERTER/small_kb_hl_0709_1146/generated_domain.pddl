(define (domain from_prolog-domain)
 ...
 (:types block pos vegetale mela agent)
 (:predicates (at ?p0 - block ?p1 - pos ?p2 - pos) (cotta ?p0 - vegetale) (on ?p0 - block ?p1 - block) (ontable ?p0 - block) (clear ?p0 - block) (intera ?p0 - mela) (moving_table_to_block ?p0 - agent ?p1 - block ?p2 - block ?p3 - pos ?p4 - pos ?p5 - pos ?p6 - pos) (morsa ?p0 - mela) (cruda ?p0 - vegetale) (available ?p0 - agent))
