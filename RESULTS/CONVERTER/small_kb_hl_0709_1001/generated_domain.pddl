(define (domain from_prolog-domain)
 ...
 (:types agent block pos mela vegetale)
 (:predicates (available ?p0 - agent) (clear ?p0 - block) (moving_table_to_block ?p0 - agent ?p1 - block ?p2 - block ?p3 - pos ?p4 - pos ?p5 - pos ?p6 - pos) (at ?p0 - block ?p1 - pos ?p2 - pos) (intera ?p0 - mela) (ontable ?p0 - block) (morsa ?p0 - mela) (cotta ?p0 - vegetale) (on ?p0 - block ?p1 - block) (cruda ?p0 - vegetale))
