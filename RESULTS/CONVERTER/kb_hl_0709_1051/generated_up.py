...
moving_onblock_to_block = Fluent('moving_onblock_to_block', BoolType(), p0=Agent, p1=Block, p2=Block, p3=Block, p4=Pos, p5=Pos, p6=Pos, p7=Pos)
...
move_table_to_table_end.add_precondition(Not(Equals(Param2, Param3)))
move_table_to_table_end.add_precondition(Not(Equals(Param2, Param4)))
move_table_to_table_end.add_precondition(Not(Equals(Param3, Param4)))
...
move_table_to_block_end.add_precondition(Not(Equals(Param2, Param4)))
move_table_to_block_end.add_precondition(Not(Equals(Param3, Param4)))
...
move_onblock_to_table_start.add_precondition(Not(Equals(Param2, Param3)))
...
move_onblock_to_table_end.add_precondition(Not(Equals(Param2, Param3)))
move_onblock_to_table_end.add_precondition(Not(Equals(Param2, Param4)))
move_onblock_to_table_end.add_precondition(Not(Equals(Param3, Param4)))
...
move_onblock_to_block_start.add_precondition(on(Param2, Param4))
move_onblock_to_block_start.add_precondition(at(Param2, Param5, Param6))
move_onblock_to_block_start.add_precondition(at(Param4, Param5, Param6))
move_onblock_to_block_start.add_precondition(at(Param3, Param7, Param8))
...
any_move_onblock_to_block_start_3 = Variable('any_move_onblock_to_block_start_3', Block)
...
any_move_onblock_to_block_start_7 = Variable('any_move_onblock_to_block_start_7', Pos)
move_onblock_to_block_start.add_precondition(Not(Exists(moving_onblock_to_block(any_move_onblock_to_block_start_0, Param2, any_move_onblock_to_block_start_2, any_move_onblock_to_block_start_3, any_move_onblock_to_block_start_4, any_move_onblock_to_block_start_5, any_move_onblock_to_block_start_6, any_move_onblock_to_block_start_7), any_move_onblock_to_block_start_0, any_move_onblock_to_block_start_2, any_move_onblock_to_block_start_3, any_move_onblock_to_block_start_4, any_move_onblock_to_block_start_5, any_move_onblock_to_block_start_6, any_move_onblock_to_block_start_7)))
...
move_onblock_to_block_start.add_precondition(Not(Equals(Param2, Param3)))
move_onblock_to_block_start.add_precondition(Not(Equals(Param2, Param4)))
move_onblock_to_block_start.add_precondition(Not(Equals(Param3, Param4)))
move_onblock_to_block_start.add_effect(available(Param1), False)
move_onblock_to_block_start.add_effect(clear(Param2), False)
move_onblock_to_block_start.add_effect(on(Param2, Param4), False)
move_onblock_to_block_start.add_effect(at(Param2, Param5, Param6), False)
move_onblock_to_block_start.add_effect(moving_onblock_to_block(Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8), True)
move_onblock_to_block_start.add_effect(clear(Param4), True)
problem.add_action(move_onblock_to_block_start)

# --- action move_onblock_to_block_end
move_onblock_to_block_end = InstantaneousAction('move_onblock_to_block_end', Param1=Agent, Param2=Block, Param3=Block, Param4=Block, Param5=Pos, Param6=Pos, Param7=Pos, Param8=Pos)
...
Param8 = move_onblock_to_block_end.parameter('Param8')
move_onblock_to_block_end.add_precondition(moving_onblock_to_block(Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8))
move_onblock_to_block_end.add_precondition(clear(Param3))
move_onblock_to_block_end.add_precondition(Not(Equals(Param2, Param3)))
move_onblock_to_block_end.add_precondition(Not(Equals(Param2, Param4)))
move_onblock_to_block_end.add_precondition(Not(Equals(Param3, Param4)))
move_onblock_to_block_end.add_effect(clear(Param3), False)
move_onblock_to_block_end.add_effect(moving_onblock_to_block(Param1, Param2, Param3, Param4, Param5, Param6, Param7, Param8), False)
move_onblock_to_block_end.add_effect(on(Param2, Param3), True)
move_onblock_to_block_end.add_effect(at(Param2, Param7, Param8), True)
