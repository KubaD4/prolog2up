(define (domain from_prolog-domain)
 ...
 (:types block pos agent mela vegetale)
 (:predicates (on ?p0 - block ?p1 - block) (at_ ?p0 - block ?p1_0 - pos ?p2 - pos) (moving_table_to_block ?p0_0 - agent ?p1 - block ?p2_0 - block ?p3 - pos ?p4 - pos ?p5 - pos ?p6 - pos) (morsa ?p0_1 - mela) (ontable ?p0 - block) (intera ?p0_1 - mela) (available ?p0_0 - agent) (cotta ?p0_2 - vegetale) (clear ?p0 - block) (cruda ?p0_2 - vegetale))
 ...
 (on ?param2 ?any_move_table_to_block_start_1))) (not (exists (?any_move_table_to_block_start_5 - pos ?any_move_table_to_block_start_0_0 - agent ?any_move_table_to_block_start_4 - pos ?any_move_table_to_block_start_3 - pos ?any_move_table_to_block_start_2 - block ?any_move_table_to_block_start_6 - pos)
