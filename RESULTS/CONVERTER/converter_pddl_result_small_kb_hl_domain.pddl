(define (domain extracted_domain-domain)
 ...
 (:predicates (moving_table_to_block ?p0 - generic ?p1 - generic ?p2 - generic ?p3 - generic ?p4 - generic ?p5 - generic ?p6 - generic) (ontable ?b1 - block) (on ?b1 - block ?b2 - block) (available ?a1 - agent) (clear ?b1 - block) (morsa ?m1 - mela) (intera ?m1 - mela) (cruda ?v1 - vegetale) (cotta ?v1 - vegetale) (at_ ?b - block ?l - location))
