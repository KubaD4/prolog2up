(define (domain from_prolog-domain)
 ...
 (:predicates (cotto ?p0 - cibo) (disponibile ?p0_0 - strumento) (pieno ?p0_1 - piano) (soddisfatto ?p0_2 - cuoco) (ha_fame ?p0_2 - cuoco) (crudo ?p0 - cibo) (vuoto ?p0_1 - piano) (su ?p0_1 - piano ?p1 - strumento))
 (:action cucina
