...
moving_table_to_block = Fluent('moving_table_to_block', BoolType(), p0=Agent)
...
a1 = Object('a1', Agent)
loc_1_1 = Object('loc_1_1', Pos)
loc_2_2 = Object('loc_2_2', Pos)
loc_1_1 = Object('loc_1_1', Pos)
loc_2_2 = Object('loc_2_2', Pos)
problem.add_objects([
    b1,
...
problem.set_initial_value(at(b1, loc_1_1, loc_1_1), True)
problem.set_initial_value(at(b2, loc_2_2, loc_2_2), True)
...
problem.add_goal(at(b1, loc_2_2, loc_2_2))
problem.add_goal(at(b2, loc_2_2, loc_2_2))
...
Param1=Agent, Param2=Block, Param3=Block, Param4=Pos, Param5=Pos, Param6=Pos, Param7=Pos)
