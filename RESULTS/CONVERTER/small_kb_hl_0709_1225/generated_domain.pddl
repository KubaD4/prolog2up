(define (domain from_prolog-domain)
 ...
 (:types vegetale agent block pos mela)
 (:predicates (cruda ?p0 - vegetale) (available ?p0 - agent) (at ?p0 - block ?p1 - pos ?p2 - pos) (intera ?p0 - mela) (moving_table_to_block ?p0 - agent ?p1 - block ?p2 - block ?p3 - pos ?p4 - pos ?p5 - pos ?p6 - pos) (on ?p0 - block ?p1 - block) (morsa ?p0 - mela) (cotta ?p0 - vegetale) (clear ?p0 - block) (ontable ?p0 - block))
